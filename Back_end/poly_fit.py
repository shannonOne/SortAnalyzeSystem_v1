...
def regression_using_polynomial(Dataset_name, Seq_len, Comp_count, Move_count):
    """
    ...
    plt.savefig('resutls_pic/' + Dataset_name + '.png')
    #plt.show()
...
if __name__ == '__main__':
    ...
    data_folder = 'data/'
    dataset_name_list = ['bubble_sort', 'quick_sort', 'select_sort', 'merge_sort', 'insert_sort']  # 差堆排序
    ...
    for dataset_name in dataset_name_list:
        ...
        coefs = regression_using_polynomial(dataset_name, seq_len, comp_count, move_count)
        # print(coefs['compare'])
        # print(coefs['move'])
