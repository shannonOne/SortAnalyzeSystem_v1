...
def sort(Org_seq):
    ...
    result_total = [result_select, result_bubble, result_quick, result_heap, result_merge, result_insert]
...
def regression_analysis(Seq_len_max, Min, Max, Sam_num, Seq_method):
    ...
    Data_folder = 'data/'
    Sort_type_list = ['bubble_sort', 'quick_sort', 'select_sort', 'merge_sort', 'insert_sort', 'heap_sort']  # 差堆排序
